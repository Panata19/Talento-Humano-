...
<html lang="es">
    <head>
        ...
        <title>Tatlento Humano admin</title>
    ...
    <body class="nav-fixed">
        <nav class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-white" id="sidenavAccordion">
            ...
            <a class="navbar-brand pe-3 ps-4 ps-lg-2" >Talento Humano</a>
            <!-- Navbar Search Input-->
            ...
            <ul class="navbar-nav align-items-center ms-auto">
                ...
                <li class="nav-item dropdown no-caret d-none d-md-block me-3">
                    <a class="nav-link dropdown-toggle" id="navbarDropdownDocs" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="fw-500">Informacion</div>
                ...
                <li class="nav-item dropdown no-caret dropdown-user me-3 me-lg-4">
                    <a class="btn btn-icon btn-transparent-dark dropdown-toggle" id="navbarDropdownUserImage" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img class="img-fluid" src="{{asset('libs/assets/img/illustrations/profiles/profile-1.png')}}" /></a>
                    <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownUserImage">
                        <h6 class="dropdown-header d-flex align-items-center">
                            <img class="dropdown-user-img" src="{{asset('libs/assets/img/illustrations/profiles/profile-1.png')}}" />
                    ...
                    <div class="sidenav-menu">
                        <div class="nav accordion" id="accordionSidenav">
                            ...
                            <div class="collapse" id="collapseDashboards" data-bs-parent="#accordionSidenav">
                                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                                    <a class="nav-link" href="dashboard-1.html">
                                        Registro
                                        <span class="badge bg-primary-soft text-primary ms-auto">Important</span>
                                    </a>
                                    <a class="nav-link" href="dashboard-2.html">Listado personal</a>
                                    <a class="nav-link" href="dashboard-3.html">Reportes</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseDashboards1" data-bs-parent="#accordionSidenav">
                                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                                    <a class="nav-link" href="dashboard-1.html">Departamento</a>
                                    <a class="nav-link" href="dashboard-2.html">Cargo</a>
                                    <a class="nav-link" href="dashboard-3.html">Regimen</a>
                                    <a class="nav-link" href="dashboard-3.html">Tipos de regimen</a>
                                    <a class="nav-link" href="dashboard-3.html">Servicio</a>
                                </nav>
                            </div>
        ...
        <script src="{{asset('libs/assets/demo/chart-area-demo.js')}}"></script>
        <script src="{{asset('libs/assets/demo/chart-bar-demo.js')}}"></script>
        <script src="https://cdn.jsdelivr.net/npm/simple-datatables@latest" crossorigin="anonymous"></script>
        <script src="{{asset('libs/js/datatables/datatables-simple-demo.js')}}"></script>
        <script src="https://cdn.jsdelivr.net/npm/litepicker/dist/bundle.js" crossorigin="anonymous"></script>
        <script src="{{asset('libs/js/litepicker.js')}}"></script>
    </body>
</html>